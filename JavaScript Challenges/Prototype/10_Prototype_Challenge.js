...
Example: If a product costs $1000 and a 10% discount is applied, the new price should be
$900.
...
Attach applyDiscount (percent) and purchase(quantity) methods to the prototype (for
memory efficiency).
